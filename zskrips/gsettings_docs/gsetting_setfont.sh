...
###org.gnome.desktop.interface monospace-font-name : 'DejaVu Sans Mono 10'
		gsettings set org.gnome.desktop.interface monospace-font-name "'${monofont_change_to}'"
...
###org.gnome.desktop.wm.preferences titlebar-font : 'Ubuntu Medium 10'
		...
		gsettings set com.github.maoschanz.drawing.tools-options last-font-name  "'${systemfont_change_to}'"
		gsettings set org.cinnamon.desktop.screensaver font-date  "'${systemfont_change_to}'"
		gsettings set org.cinnamon.desktop.screensaver font-message  "'${systemfont_change_to}'"
		gsettings set org.cinnamon.desktop.screensaver font-time  "'${systemfont_change_to}'"
		gsettings set org.gnome.libgnomekbd.indicator font-family  "'${systemfont_change_to}'"
		gsettings set org.onboard key-label-font  "'${systemfont_change_to}'"
		gsettings set org.onboard.theme-settings key-label-font  "'${systemfont_change_to}'"
		gsettings set org.x.editor.preferences.print print-font-header-pango  "'${systemfont_change_to}'"
		gsettings set org.x.editor.preferences.print print-font-numbers-pango  "'${systemfont_change_to}'"
		gsettings set org.x.pix.image-print font-name  "'${systemfont_change_to}'"
		gsettings set org.x.pix.image-print footer-font-name  "'${systemfont_change_to}'"
		gsettings set org.x.pix.image-print header-font-name  "'${systemfont_change_to}'"
		gsettings set org.x.sticky font  "'${systemfont_change_to}'"
		gsettings set x.dm.slick-greeter font-name  "'${systemfont_change_to}'"
		##############
		gsettings set org.x.editor.preferences.editor editor-font  "'${systemfont_change_to}'"
		######
		gsettings set org.x.editor.preferences.print print-font-body-pango  "'${systemfont_change_to}'"
		gsettings set org.x.viewer.plugins.pythonconsole font  "'${systemfont_change_to}'"
		######
