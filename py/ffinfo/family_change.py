...
##############    
def family_chnage(sfddir,old_new_lang_dikt,pfiks,sfiks,familyname):
    for lang in old_new_lang_dikt:
        fontfileobzekt = fontforge.open(f"{sfddir}/{pfiks}{lang}{sfiks}.sfd")
        print("####################")
        print(f"fontfileobzekt file_path is {fontfileobzekt.path}")    
        print("####################")    
        # ########
        # todayd = datetime.today().strftime('%Y-%m-%d')
        # unikname = f"{newfontname} hscii 4finger1thumb 4f1t maths {todayd}"
        fontfileobzekt.familyname = f"{pfiks}{lang}{sfiks}"#f"{familyname}"
        ...
        # # ########
        # fontfileobzekt.save(f"{sfddir}/{pfiks}{lang}{sfiks}.sfd")
        fontfileobzekt.save()
        # ########
...
if __name__ == "__main__":
    ...
    old_new_lang_dikt = {
        "inglish":"inglishenglosoftw8mono",
        "hindi":"hindienglosoftw8mono", "bangla":"banglaenglosoftw8mono",
        "guzrati":"guzratienglosoftw8mono", "gurmukhi":"gurmukhienglosoftw8mono", "oriya":"oriyaenglosoftw8mono",
        "tamil":"tamilenglosoftw8mono", "telugu":"teluguenglosoftw8mono", "kannada":"kannadaenglosoftw8mono",
        "malayalam":"malayalamenglosoftw8mono", "sinhala":"sinhalaenglosoftw8mono", "korean":"koreanenglosoftw8mono",
        "binaryw":"binarywenglosoftw8mono",
        # "heks":"heksenglosoftw8mono",
    }
    pfiks = ""
    sfiks = "englosoftw8mono"
    familyname = "englosoftw8mono"
    family_chnage(sfddir,old_new_lang_dikt,pfiks,sfiks,familyname)
